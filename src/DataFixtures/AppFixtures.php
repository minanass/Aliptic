...
class AppFixtures extends Fixture
{
    ...
    public $structure_grid_2_level_3 = [[5,1,0,7,8,3,6,2,4],[8,3,0,6,9,4,1,5,7],[7,4,0,2,1,5,9,3,8],[6,8,0,4,3,9,2,1,5],[1,5,0,8,2,6,7,4,9],[2,9,4,5,7,1,3,8,6],[9,6,5,1,4,2,8,7,3],[3,7,1,9,5,8,4,6,2],[42,8,3,6,7,5,9,1]];
    public $solution_grid_3_level_3 = [[4,6,1,7,3,5,9,2,8],[9,3,7,2,8,6,1,5,4],[2,5,8,9,1,4,6,7,3],[5,8,2,1,9,7,4,3,6],[6,9,3,4,5,2,7,8,1],[1,7,4,3,6,8,2,9,5],[3,1,6,5,2,9,8,4,7],[7,2,5,8,4,1,3,6,9],[84,9,6,7,3,5,1,2]];
