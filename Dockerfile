...
LABEL Description="Cutting-edge LAMP stack, based on Ubuntu 20.04 LTS. Includes .htaccess support and popular PHP7.4 features." \
	...
	Usage="docker run -d -p [HOST WWW PORT NUMBER]:80  -p [HOST DB PORT NUMBER]:3306 -v [HOST DB DOCUMENT ROOT]:/var/lib/mysql -v [HOST WWW DOCUMENT ROOT]:/var/www/html  lamp/perso" \
	Version="1.0"
