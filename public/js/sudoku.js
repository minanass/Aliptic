...
let solution_element = document.getElementById("solution");
let structure_element = document.getElementById("structure");
select.addEventListener("change", (event) =>{
    let board_created = sudoku.generate(event.target.value)
    structure_element.value = board_created ;
    solution_element.value = sudoku.solve(board_created);
});
/*
Sudoku.js
---------
