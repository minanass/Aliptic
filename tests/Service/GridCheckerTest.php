<?php
    ...
    class GridCheckerTest extends TestCase
    {
        ...
        // Arrange: préparer  les données à utiliser pour le test
        $grid = new GridChecker();
        $arrayChange = [["",7,5,6,3,4,8,2,9],["",8,2,4,1,9,7,6,5],["",6,3,8,2,7,5,1,4],[7,4,1,9,8,2,6,3,5],[3,9,6,7,4,5,1,8,2],[2,5,8,3,6,1,9,4,7],[8,1,7,4,9,3,2,5,6],[5,2,4,1,7,6,3,9,8],[6,3,9,2,5,8,4,7,1]];
        //dd($array);
        // Act: appeller la méthode à tester
       ...
       //dd($changedArray);
        ...
        public function testcheckerAnswerGridChecker()
        {
        // Arrange: préparer  les données à utiliser pour le test
        $grid = new GridChecker();
        $answer = [[1,7,5,6,3,4,8,2,9],[3,8,2,4,1,9,7,6,5],[9,6,3,8,2,7,5,1,4],[7,4,1,9,8,2,6,3,5],[3,9,6,7,4,5,1,8,2],[2,5,8,3,6,1,9,4,7],[8,1,7,4,9,3,2,5,6],[5,2,4,1,7,6,3,9,8],[6,3,9,2,5,8,4,7,1]];
        $solution = [[1,7,5,6,3,4,8,2,9],[3,8,2,4,1,9,7,6,5],[9,6,3,8,2,7,5,1,4],[7,4,1,9,8,2,6,3,5],[3,9,6,7,4,5,1,8,2],[2,5,8,3,6,1,9,4,7],[8,1,7,4,9,3,2,5,6],[5,2,4,1,7,6,3,9,8],[6,3,9,2,5,8,4,7,1]];
        $solution = $grid->checkerAnswer($answer,$solution);
        $this->assertTrue($solution, $grid->checkerAnswer($answer,$solution));
        }
